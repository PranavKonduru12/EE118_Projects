...
HD_PWD='C:/Users/013162916/labE/labE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log amult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source amult.tcl -notrace
