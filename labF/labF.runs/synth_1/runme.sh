...
HD_PWD='C:/Users/pskon/Workbench_repo/Fall2021_EE118_labs_repo/labF/labF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiple_storage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiple_storage.tcl
