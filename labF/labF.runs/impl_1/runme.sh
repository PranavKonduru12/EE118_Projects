...
HD_PWD='C:/Users/pskon/Workbench_repo/Fall2021_EE118_labs_repo/labF/labF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiple_storage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiple_storage.tcl -notrace
