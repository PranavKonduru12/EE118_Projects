...
HD_PWD='C:/Users/pskon/Workbench_repo/Fall2021_EE118_labs_repo/LabH/LabH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log textScrolling.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source textScrolling.tcl -notrace
