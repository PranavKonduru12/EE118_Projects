...
HD_PWD='C:/Users/pskon/Workbench_repo/Fall2021_EE118_labs_repo/LabH/LabH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log textScrolling.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source textScrolling.tcl
