...
HD_PWD='C:/Users/pskon/Workbench_repo/lab3_v2/lab3_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fulladder4bit.tcl -notrace
