...
HD_PWD='C:/Users/pskon/Workbench_repo/lab3_v2/lab3_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fulladder4bit.tcl
